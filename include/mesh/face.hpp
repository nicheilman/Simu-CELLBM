...
class face final
{
	...
	double area_memory_ = -1.;       // Face area from previous timestep
	...
	void set_area_memory(double area) noexcept;
	...
	const unsigned get_global_id() const noexcept {return global_face_id_;};
 
        //Return the face area
        inline double get_area() const noexcept {return area_;}
        inline double get_area_memory() const noexcept {return area_memory_;}
	    ...
	    float get_surface_tension() const noexcept {return surface_tension_;}
	    void set_surface_tension(float new_surface_tension) noexcept {surface_tension_ = new_surface_tension;}  
