    ...
    for(short i = 0; i < max_nb_tries; ++i){
        ...
        try{
            ...
            switch(cell_type->global_type_id_){
                ...
                case 4: {c0 = std::make_shared<lumen_cell>      (cell_surface_mesh, cell_id, cell_type);    break;}
                case 3: {c0 = std::make_shared<nucleus_cell>    (cell_surface_mesh, cell_id, cell_type);    break;}
                case 2: {c0 = std::make_shared<static_cell>     (cell_surface_mesh, cell_id, cell_type);    break;}
		case 5: {c0 = std::make_shared<rbc_cell>        (cell_surface_mesh, cell_id, cell_type);    break;}
